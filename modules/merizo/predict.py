...
def run_merizo(input_paths: List[str], output_path: str, device: str = 'cpu', max_iterations: int = 3, return_indices: bool = False, 
    ...
    Args:
        ...
        output_path (str): Path to output PDB files.
    ...
    with torch.no_grad():
        for pdb_path in input_paths:
            if os.path.exists(pdb_path):
                ...
                pdb_out = os.path.join(output_path, pdb_bn.split("/")[-1] + "_domain")
...
if __name__ == "__main__":
    ...
    parser.add_argument("-o", "--output", type=str, required=True, help="Specify path to storing output files.")
