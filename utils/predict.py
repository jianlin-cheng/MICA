...
class CryoEMPredictor:
    ...
    def select_processing_strategy(self):
        ...
        try:
            ...
            self._print_status(f"You may change batch threshold parameter: {self.batch_threshold} to lower value if run on your local machine by changing its value in: utils/predict.py")
