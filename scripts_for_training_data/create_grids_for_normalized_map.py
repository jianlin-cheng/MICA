...
def main():
    ...
    parser.add_argument("--output-dir", default="Training_Dataset/Grids/normalized_maps",
    ...
    for i, directory in enumerate(BASE_DIR):
        ...
        normalized_map = f"{directory}/resampled_normalized_map.mrc"
        ...
        try:
            ...
            print(f"Created {grid_count} number of normalized map grids for EMD ID: {emd_id} | Completed {i + 1} maps")
        except Exception as e:
            print(f"Normalized map grid creation failed for EMD ID: {emd_id} - Error: {str(e)}")
